  ...
  describe("Transactions", function () {
    ...
    describe("addToBlockChain ", function () {
        it("should see the getTransactionCount == 1", async function () {
          ...
          console.log("owner => ", owner.address);
          const transfer = await transaction.addToBlockchain(receiver, amount, message, keyword);
      ...
      describe("call the addToBlockChain 3 time and expect the transactionCount to be 3 ", function () {
        it("should see the getTransactionCount == 3", async function () {
          ...
          const keyword = 'testKeyword'
          console.log("owner => ", owner.address);
          const transfer1 = await transaction.addToBlockchain(receiver, amount, message, keyword);
          const transfer2 = await transaction.addToBlockchain(receiver, amount, message, keyword);
          const transfer3 = await transaction.addToBlockchain(receiver, amount, message, keyword);
        //   console.log("transfer => ", transfer);
          const count = await transaction.getTransactionCount();
          console.log("transactionCount => ", count.toNumber());
